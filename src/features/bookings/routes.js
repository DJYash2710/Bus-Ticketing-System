...
import { cancelBookingController, createBookingController, getBookingByIdController, getMyBookingsController, getOperatorBookingsController, } from "./controller.js";
...
router.get("/operator/bookings", requireRole(["OPERATOR"]), getOperatorBookingsController);

...
import { getSeatByIdController, listSeatsByScheduleController, updateSeatStatusController, } from "./controller.js";
...
router.patch("/:id/status", authMiddleware, requireRole(["ADMIN", "OPERATOR"]), validate(updateSeatStatusSchema), updateSeatStatusController);
